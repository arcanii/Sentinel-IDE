...
- **It is a git repo** (branch `main`, GPL-3.0 `LICENSE`, `README.md`, `.gitignore`,
  `.gitattributes`) — **no remote yet**; the plan of record is a *private* `Sentinel-IDE` repo.
...
>
> **Git.** It's a repo (`main`, GPL-3.0 `LICENSE`, `README.md`, `.gitignore`, `.gitattributes`) with
> **no remote** — the plan of record is a **private** `Sentinel-IDE` repo, then
> `git remote add origin <url> && git push -u origin main`. Commit only when asked.
>
